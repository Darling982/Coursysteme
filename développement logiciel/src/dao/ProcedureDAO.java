 ...
 * @autho Equipe7_4
 * @version finale
 * classe permettant de connecter le système du lance dela procédure de la BDD au code
 */

public class ProcedureDAO {
/**
 * méthode permettant de vérifier l'ouverture des choix pour les fises
 * @return un boolean
 */
...
/**
 * méthode permettant de vérifier l'ouverture des choix au fisa
 * @return un boolean 
 */
...
/**
 * méthàde permettant de modifier la période de choix aux fises
 * @param ouvert
 */
...
/**
 * méthode permettant de modifier la période de choix aux fisas
 * @param ouvert
 */

 ...
 * @author Equipe7_4
 * @version finale
 * Classe permettant à l'administrateur de faire la gestion administratif
 */
   ...
   private void initialize() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                btnNewButton_3.setBounds(25, 20, 85, 21);
                ...
                saisieFrame.getContentPane().add(btnNewButton_3);
        ...
        JButton btnNewButton_1 = new JButton("MODIFIER ETAT DOMINANTE");
